        ...
        <div className="pb-4 pt-2">
          {cartItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-8 text-neutral-400 gap-4">
              ...
              <p className="text-sm max-w-70 text-center">Người ta có đôi có cặp, còn giỏ hàng của bạn thì… trống trơn</p>
            </div>
          ) : (
            <>
              <div className="flex justify-between items-center text-[15px] mb-4 pb-2 border-b ">
                ...
                <Link to="/cart" className="text-blue-500 hover:underline font-medium">
                  Xem tất cả
                </Link>
              </div>
