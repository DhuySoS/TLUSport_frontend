          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 group cursor-pointer">
              <svg
                ...
                height="1.6em"
                viewBox="0 0 512 512"
                className="text-neutral-400 group-hover:text-white transition-colors duration-200 shrink-0"
              >
                <path
                  fill="currentColor"
              ...
              <div className="font-bold">
                ...
                <p className="text-sm group-hover:text-neutral-300 transition-colors duration-200">
                  1900 9999
                </p>
              </div>
            </div>
