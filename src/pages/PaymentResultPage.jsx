      ...
      try {
        ...
        if (data.code === 200) {
          ...
          if (match && match[1]) {
            ...
            const currentOrder = curOrder.data?.items?.find(
              (order) => order.orderId == match[1],
            );
            if (currentOrder) {
      ...
      <div className="max-w-2xl w-full mx-auto px-6 py-12">
        {status === "success" ? (
            ...
            {curOrderData &&
              ...
              curOrderData.items.length > 0 && (
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8 text-left max-w-lg mx-auto">
                  ...
                  <div className="space-y-4 max-h-70 overflow-y-auto pr-2 scrollbar-thin">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              {message || "Đơn hàng của bạn chưa được xác nhận."}
            </p>
